...
###########################################
# PE ENTRY
mondayentry = round(float(opopen)*1.5)
mondaytarget = round(float(mondayentry)*1.25)
mondaystoploss = round(float(mondayentry)*0.75)
print("#######################################")
...
print("*******")
# CE ENTRY
mondayentryC = round(float(opopenC)*1.5)
mondaytargetC = round(float(mondayentryC)*1.25)
mondaystoplossC = round(float(mondayentryC)*0.75)
