...
###########################################
# PE ENTRY
mondayentry = round(float(opopen)*1.4)
mondaytarget = round(float(mondayentry)*1.2)
mondaystoploss = round(float(mondayentry)*0.8)
print("#######################################")
...
print("*******")
# CE ENTRY
mondayentryC = round(float(opopenC)*1.4)
mondaytargetC = round(float(mondayentryC)*1.2)
mondaystoplossC = round(float(mondayentryC)*0.8)
