...
###########################################
# PE ENTRY
mondayentry = round(float(opopen)+0)
mondaytarget = round(float(mondayentry)+50)
mondaystoploss = round(float(mondayentry)-50)
print("#######################################")
...
print("*******")
# CE ENTRY
mondayentryC = round(float(opopenC)+1)
mondaytargetC = round(float(mondayentryC)+50)
mondaystoplossC = round(float(mondayentryC)-50)
